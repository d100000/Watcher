...
namespace Helper
{
    ...
    public class GridOperation
    {
        ...
        /// <param name="from"></param>
        /// <param name="to"></param>
        public static void Showwidht(FrameworkElement grid, double from, double to)
        {
            grid.Width = from;
            DoubleAnimation da = new DoubleAnimation
            {
            ...
            grid.BeginAnimation(FrameworkElement.WidthProperty, da);//开始动画
        }

        public static void ShowTop(Window grid, double from, double to)
        {
            grid.Top = from;
            DoubleAnimation da = new DoubleAnimation
            {
            ...
            grid.BeginAnimation(Window.TopProperty, da);//开始动画
        }

        public static void ShowLeft(Window grid, double from, double to)
        {
            grid.Left = from;
            DoubleAnimation da = new DoubleAnimation
            {
            ...
            grid.BeginAnimation(Window.LeftProperty, da);//开始动画
        }
